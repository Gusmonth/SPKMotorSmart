                ...
                <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3><i class="bi bi-stack"></i> Data Kriteria</h3>
                                <p class="text-subtitle text-muted">Daftar Data Kriteria yang Tersimpan.</p>
                            </div>
                    ...
                    <div class="card">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="bg-dark modal-header">
                                            <h5 class="text-white modal-title" id="exampleModalCenterTitle">Tambah Data Kriteria</h5>
                                        ...
                                        <div class="row">
                                                    <div class="col-md-4">
                                                        <label><strong>Kode Kriteria</strong></label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="first-name" class="form-control" name="kode" placeholder="Kode Kriteria" required autocomplete="off">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label><strong>Nama Kriteria</strong></label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="email-id" class="form-control" name="nama" placeholder="Nama Kriteria" required autocomplete="off">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label><strong>Bobot Kriteria</strong></label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" id="contact-info" class="form-control" name="bobot" placeholder="Bobot Kriteria" required autocomplete="off">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label><strong>Jenis Kriteria</strong></label>
                                                    </div>
                                                <div class="col-md-8 form-group">
                                                    <select name="jenis" class="form-select" id="basicSelect" required>
                                                        <option></option>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button name="tambah-kriteria" type="submit" class="btn btn-success ml-1"><i class="bx bx-check d-block d-sm-none"></i>
                        ...
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td class='text-center'>
                                                    <div class='d-flex justify-content-center'>
                                                        <a class='btn btn-outline-warning me-2' data-bs-toggle='modal' data-bs-target='#edit_data" .$baris['id_kriteria'] . "'><i class='bi bi-pencil-fill'></i></a>
                                                        <a class='btn btn-outline-danger' data-bs-toggle='modal' data-bs-target='#hapus_data" . $baris['id_kriteria'] . "'><i class='bi bi-trash-fill'></i></a>
                                                    </div>
                                                </td>
                                            </tr> ";
                                            $no++;
                            ...
                            <?php
                                $total_bobot = 0;
                                $query = mysqli_query($koneksi, "SELECT CAST(SUM(bobot_kriteria) AS DECIMAL(10,2)) AS bobot FROM kriteria");
                                if ($row = mysqli_fetch_array($query)) {
                                    $total_bobot = $row['bobot'] * 100;
                                }
                            ?>
                            <div class="progress progress-dark mb-3">
                                <div class="progress-bar progress-label" role="progressbar" style="width: <?php echo $total_bobot; ?>%" aria-valuenow="<?php echo $total_bobot; ?>"
                                    aria-valuemin="0" aria-valuemax="100" title="Total Bobot: <?php echo $total_bobot; ?>%">
                                </div>
                            </div>
                            <div class="text-center">
                                <strong>Total Bobot: <?php echo $total_bobot; ?>%</strong>
                            </div>
                            <?php
                            $query = mysqli_query($koneksi, "SELECT * FROM kriteria");
                            ...
                            <div class="modal fade" id="edit_data<?= $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="bg-dark modal-header">
                                            <h5 class="text-white modal-title" id="exampleModalCenterTitle">Edit Data Kriteria</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <?php
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="first-name" class="form-control" name="kode" placeholder="Kode Kriteria" value="<?= $baris['kode_kriteria']; ?>" readonly>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label><strong>Nama Kriteria</strong></label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="email-id" class="form-control" name="nama" placeholder="Nama Kriteria" value="<?= $baris['nama_kriteria']; ?>" required autocomplete="off">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label><strong>Bobot Kriteria</strong></label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" id="contact-info" class="form-control" name="bobot" placeholder="Bobot Kriteria" value="<?= $baris['bobot_kriteria'] * 100; ?>" required autocomplete="off">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label><strong>Jenis Kriteria</strong></label>
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal"><i class="bx bx-x d-block d-sm-none"></i>
                                            <span class="d-none d-sm-block">Tutup</span></button>
                                            <button name="edit-kriteria" type="submit" class="btn btn-warning ml-1"><i class="bx bx-check d-block d-sm-none"></i>
                            ...
                            <div class="modal fade" id="hapus_data<?= $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="bg-darkmodal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Hapus Data Kriteria</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form class="form form-horizontal" action="proses.php" method="post">
                                        ...
                                        <a href="hapus-data-kriteria.php?id=<?= $id; ?>" class="btn btn-danger">Hapus</a> 
                                        </div>
                                    </div>
                                    </div>
                                    </div>
